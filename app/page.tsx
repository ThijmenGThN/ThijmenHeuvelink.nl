                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    <div className="text-center">
                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            <Link target="_blank" href="https://github.com/ThijmenGThN" className="text-sm font-semibold leading-6 text-gray-900">
                                Checkout my GitHub <span aria-hidden="true">→</span>
                            </Link>
                        </div>
                    </div>
                </div>
